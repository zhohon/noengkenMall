...
public class HtmlService {
    ...
    public void buildHtml(String templateFilePath, String htmlFilePath, Map<String, Object> data) {
        try {
            ...
            resourceLoader.setRoot(PathKit.getWebRootPath());
            ...
            e.printStackTrace();
            throw new RuntimeException("create template error:", e);
        }
    }
    ...
    public void productContentBuildHtml(Product product, HttpServletRequest request) {
