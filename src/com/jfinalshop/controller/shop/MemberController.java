...
public class MemberController extends Controller{
	...
	public void login() {		
		...
		loginMember.set("loginIp", RequestUtil.getRemoteHostIp(getRequest()));
	...
	public void ajaxRegister() {
		...
		member.set("registerIp", RequestUtil.getRemoteHostIp(getRequest()));
		member.set("loginIp",RequestUtil.getRemoteHostIp(getRequest()));
